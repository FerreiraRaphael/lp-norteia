      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-gliker text-brand-dark leading-tight mb-6">
            Quer entender onde a <span className="text-brand-pink">IA</span> pode ajudar sua empresa?
          </h2>
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-brand-pink text-white px-10 py-5 rounded-full text-sm font-medium tracking-wide transition-all hover:scale-105 shadow-lg shadow-brand-pink/30 hover:shadow-xl hover:shadow-brand-pink/40 animate-pulse-soft"
          >
