    ...
    <section className="py-24 md:py-32 bg-brand-cream">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          <div className="p-10 rounded-[2rem] bg-brand-blue/25 card-float">
            <div className="w-16 h-16 rounded-2xl bg-brand-blue/40 flex items-center justify-center mb-6">
          ...
          <div className="p-10 rounded-[2rem] bg-brand-pink/25 card-float">
            <div className="w-16 h-16 rounded-2xl bg-brand-pink/40 flex items-center justify-center mb-6">
              <svg className="w-8 h-8 text-brand-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
